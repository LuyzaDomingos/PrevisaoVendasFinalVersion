        ...
        html.Div(
            children=[
                html.A(
                    children=[
                        html.Img(
                            src=app.get_asset_url("serie.png"),
                            style={"width": "100px", "height": "100px"},
                        ),
                        html.P(
                            "Previsão por Produtos", className="secondlink"
                        ),
                    ],
                    href="/apps/app1",
                    className="column",
                ...
                html.A(
                    children=[
                        html.Img(
                            src=app.get_asset_url("previsao.png"),
                            style={"width": "100px", "height": "100px"},
                        ),
                        html.P(
                            "Previsão por Categoria", className="secondlink"
                        ),
                    ],
                    href="/apps/app2",
                    className="column",
                ...
                html.A(
                    children=[
                        html.Img(
                            src=app.get_asset_url("venda.png"),
                            style={"width": "100px", "height": "100px"},
                        ),
                        html.P(
                            "Painel de Vendas", className="secondlink"
                        ),  # style = {'color': 'gray'}
                    ],
                    href="/apps/app4",
                    className="column",
...
categories = [
    "ELETRO LINHA BRANCA",
    "ELETRO TV E SOM",
    "ELETRO TELEFONIA CELULAR",
    "ELETRO INFORMATICA",
    "MOVEIS COLCHAO",
    "ELETRO PORTATEIS",
    "MOVEIS MADEIRA",
    "ELETRO UTILIDADE DO LAR",
    "MOVEIS ACO, TUBO E PLASTICO",
    "ELETRO BIC.,BRINQ. E CARRO DE",
    "MOVEIS ESTOFADOS",
    "ELETRO AUTO RADIO",
    "ELETRO ELETRO RELOGIO",
    "ELETRO TELEFONES E ACESSORIOS",
    "0",
    "INFORMATICA",
    "ELETRO MOTOCICLETAS",
...
categories_paths_3 = [
    "/apps/app3" + category.replace(" ", "_") for category in categories
]
categories_paths_5 = [
