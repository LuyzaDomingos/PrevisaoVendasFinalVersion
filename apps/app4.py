    ...
    children=[
        ...
        html.Div(
            children=[
                ...
                html.P(
                    children="Visualização das vendas por região, loja, ou geral.",
        ...
        html.Div(
            ...
            className="menu",
            style={"height": "90px", "padding-top": "12px"},
        ),
        html.Div(
            id="items-list",
            className="wrapper",
...
def set_active(*args):
    ...
    if not ctx.triggered or not any(args):
        return [
            "flex-item" if x > 0 else "flex-item selected" for x in range(3)
        ]
    ...
    if button_id == "bt-store":
        return (
            get_list(
                ...
                items=stores,
                sales_panel=True,
                sales_data=data_stores_regions_m,
                sales_panel_category=args[3],
            ),
            {"max-width": "1024px"},
            "bt-store",
        )
