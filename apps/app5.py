        ...
        children=[
            ...
            html.Div(
                children=[
                    html.Br(),
                    html.H1(
                        children="Relatório de " + actual_category,
                        className="header-title",
                    ),
                    html.P(
                        children="Visualização das vendas por região, loja, ou geral. Os dados são fictícios. WIP.",
...
@app.callback(
    [
        Output("critical-items-list", "children"),
        Output("critical-items-list", "style"),
    ],
