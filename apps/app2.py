...
order_dict = {"Crescente": 1, "Decrescente": 0}
    ...
    children=[
        html.Div(
            children=[
                ...
                html.H1(
                    children="Previsão por Categoria", className="header-title"
                ),
                html.P(
                    children="Indicadores de previsão de vendas, estoque, cobertura, e comparação com o mês anterior.",
                ...
                html.Button(
                    "Baixe a previsão", id="bt-download", className="bt"
                ),
        ...
        html.Div(
            children=[
                html.Div(
                    children=[
                        html.Div(
                            children="Ordernar por", className="menu-title"
                        ),
                        dcc.Dropdown(
...
@app.callback(Output("download", "data"), [Input("bt-download", "n_clicks")])
